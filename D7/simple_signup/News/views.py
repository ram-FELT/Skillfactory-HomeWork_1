...
from .tasks import weekly_mailing_list
...
class NewsCreate(PermissionRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        mailing_list.apply_async([form.instance.Title, form.instance.Text], countdown=10, expires=30)
...
class NewsUpdate(PermissionRequiredMixin, UpdateView):
    ...
    model = News
    template_name = 'news_edit.html'
''' проверка работы еженедельной россылки
    def form_valid(self, form):
        weekly_mailing_list.apply_async([], countdown=10, expires=30)
